...
✅ Added a processes[] array to store process IDs instead of passing NULL.
✅ Fixed fat(NULL, n, bt); to fat(processes, n, bt);
✅ Used int instead of declaring i separately to improve readability.
*/